...
public class updateHTML extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("Name of the domain.Instrument: <input type='text' name='nume' value='" + nume + "'>");
        out.println("Type of the domain.Instrument: <input type='text' name='type' value='" + type + "'>");
        out.println("Price of the domain.Instrument: <input type='text' name='pret' value='" + pret + "'>");
